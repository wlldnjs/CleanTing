...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter(AlarmFragment context, List<String> listDataHeader, HashMap<String,List<String>>listHashMap){
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            LayoutInflater inflater=(LayoutInflater)this.context.getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
